...
public class Utils {
	...
	public static void printDB(Hashtable<String, ProductInfo> itemsInDB) {
		...
		while (items.hasMoreElements()) {
															...
															// PackagedProduct
			{
				...
				System.out.println("Category: " + tempPP.getCategory());
																...
																// BulkProduct
			{
				...
				System.out.println("Category: " + tempBP.getCategory());
	...
	public static void printCart(CheckOutCart cc) {
		...
		while (itemsInCart.hasMoreElements()) {
			tempGI = itemsInCart.nextElement();
